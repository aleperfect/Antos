/**
𝘼𝙉𝙏𝙊 𝘿𝙕𝙉@BrunoSobrino - _antitrabas.js
...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '56949634570-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝘼𝙉𝙏𝙊 𝘿𝙕𝙉', 'jpegThumbnail': null } } };
